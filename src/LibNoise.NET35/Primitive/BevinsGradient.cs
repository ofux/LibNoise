...
namespace LibNoise.Primitive
{
    ...
    // Constants used by the current version of libnoise.
        ...
        private static readonly double[] RandomVectors = {
        ...
        public double GradientCoherentNoise3D(double x, double y, double z, long seed, NoiseQuality quality)
        {
        ...
        private double GradientNoise3D(double fx, double fy, double fz, int ix, int iy, int iz, long seed)
        {
